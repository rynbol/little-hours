...
export const FURNITURE = [
  ...
  { id: 'moon-clock', name: 'Moon clock', category: 'Wall decor', description: 'A brass pendulum clock that keeps the real time.', mount: 'wall', size: [0.86, 1.64], depth: 0.14, color: '#bf9762', blocking: false, clock: true },
  { id: 'wall-clock', name: 'Wall clock', category: 'Wall decor', description: 'A round clock with a soft rim that keeps the real time.', mount: 'wall', size: [0.72, 0.72], depth: 0.12, color: '#bea0c6', blocking: false, clock: true },
